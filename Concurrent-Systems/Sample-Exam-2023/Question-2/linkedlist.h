...
int linkedlist_lookup(struct linkedlist * ll, char * item);

// add an item, with number 'item' to the set
// has no effect if the item is already in the set.
// New items that are not already in the set should
// be added to the start of the list
void linkedlist_add(struct linkedlist * ll, char * item);

// remove an item with number 'item' from the set
void linkedlist_remove(struct linkedlist * ll, char * item);

// free the linked list structure
void linkedlist_free(struct linkedlist * ll);
